...
async def get_evaluation_criteria(visa_type: str) -> dict:
    ...
    criteria_map = {
        "H-1B": [
            {"id": "1", "name": "Specialty Occupation", "description": "Position requires theoretical and practical application of specialized knowledge"},
            {"id": "2", "name": "Beneficiary Qualifications", "description": "Beneficiary has required degree or equivalent"},
            {"id": "3", "name": "Employer-Employee Relationship", "description": "Valid employer-employee relationship exists"},
            {"id": "4", "name": "Prevailing Wage Compliance", "description": "Offered wage meets or exceeds prevailing wage"},
            {"id": "5", "name": "LCA Compliance", "description": "Labor Condition Application is certified and compliant"},
            {"id": "6", "name": "Itinerary Requirements", "description": "Work itinerary provided if applicable"}
        ],
        "O-1": [
            {"id": "1", "name": "Extraordinary Ability", "description": "Sustained national or international acclaim"},
            {"id": "2", "name": "Evidence of Recognition", "description": "Documentation of achievements and recognition"},
            {"id": "3", "name": "Continued Work in Field", "description": "Coming to US to continue work in area of expertise"}
        ],
        "EB-2 NIW": [
            {"id": "1", "name": "Advanced Degree", "description": "Holds advanced degree or exceptional ability"},
            {"id": "2", "name": "National Interest", "description": "Work is in the national interest of the United States"},
